    ...
    <div class="col-lg-6">
        <div class="card m-b-3">
            <div class="card-body">
                ...
                <p class="text-muted m-b-4">Bootstrap 进度条</p>
        ...
        <div class="card m-b-3">
            <div class="card-body">
                ...
                <p class="text-muted m-b-4">Bootstrap 弹出框</p>
        ...
        <div class="card m-b-3">
            <div class="card-body">
                ...
                <p class="text-muted m-b-4">Bootstrap 提示框</p>
                <div class="button-items">
        ...
        <div class="card m-b-3">
            <div class="card-body">
                ...
                <p class="text-muted m-b-4">Bootstrap 下拉菜单</p>
                <ul class="list-unstyled">
                    <li class="btn-group">
        ...
        <div class="card m-b-3">
            <div class="card-body">
                ...
                <p class="text-muted m-b-4">Bootstrap 折叠</p>
                <div id="accordion">
                    @for ($i = 0; $i < 5; $i++)
                        <div class="card">
    ...
    <div class="col-lg-6">
        <div class="card m-b-3">
            <div class="card-body">
                ...
                <p class="text-muted m-b-4">Bootstrap 标记</p>
                <ul class="list-unstyled">
                    <li class="m-b-2">
        ...
        <div class="card m-b-3">
            <div class="card-body">
                ...
                <p class="text-muted m-b-4">Bootstrap 轮播</p>
        ...
        <div class="card m-b-3">
            <div class="card-body">
                ...
                <p class="text-muted m-b-4">Bootstrap 列表组</p>
                <ul class="list-group">
